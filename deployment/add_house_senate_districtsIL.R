...
# MHVillage
mhvillage_df <- read.csv("data/MHVillage_IL_Parks.csv")

house_districts <- read_sf("data/house.json")
senate_districts <- read_sf("data/senate.json")
...
write.csv(csvOut, "data/MHvillage_IL_addedDistricts.csv", row.names = FALSE)
